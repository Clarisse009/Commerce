...
$categorie_id = 2; // ID de la catégorie "Décoration"
    ...
    <section id="section-ronde">
        <div class="container">
            <div class="case-ronde">
                <a href="femme.php"><img src="../images/jupe2.jpg" alt="Femmes" class="img-ronde"></a>
                <div class="case-titre">
                    <h5>Femmes</h5> 
                </div>
            </div>
            <div class="case-ronde">
                <a href="homme.php"><img src="../images/chemise_homme6.jpg" alt="Hommes" class="img-ronde"></a>
                <div class="case-titre">
                    <h5>Hommes</h5>
                </div>
            </div>
